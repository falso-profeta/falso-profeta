...
{
	if (region.di.aY === region.dP.aY)
	{
		return 'on line ' + region.di.aY;
	}
	return 'on lines ' + region.di.aY + ' through ' + region.dP.aY;
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		xhr.addEventListener('load', function() {
			callback(_Http_handleResponse(xhr, request.cX.a));
		});

		try
		{
			xhr.open(request.c6, request.fo, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail(elm$http$Http$BadUrl(request.fo)));
		}
...
function _Http_configureRequest(xhr, request)
{
	...
	xhr.responseType = request.cX.b;
	xhr.withCredentials = request.dr;

	elm$core$Maybe$isJust(request.dp) && (xhr.timeout = request.dp.a);
}
...
function _Http_toResponse(xhr)
{
	return {
		fo: xhr.responseURL,
		fh: { eT: xhr.status, I: xhr.statusText },
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { e0: 'hidden', aN: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { e0: 'mozHidden', aN: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { e0: 'msHidden', aN: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { e0: 'webkitHidden', aN: 'webkitvisibilitychange' }
		: { e0: 'hidden', aN: 'visibilitychange' };
}
...
var author$project$Model$ShowCover = 0;
...
var author$project$Model$Neutral = 2;
...
var author$project$Model$Story = F9(
	function (state, bible, ref, utter, context, youtube, image, events, rants) {
		return {dA: bible, dK: context, dR: events, c0: image, ei: rants, ek: ref, dk: state, eH: utter, eK: youtube};
	});
var author$project$Model$Event = F4(
	function (title, text, source, image) {
		return {c0: image, et: source, ex: text, fk: title};
	});
var author$project$Model$Source = F2(
	function (name, url) {
		return {e8: name, fo: url};
	});
...
var author$project$Model$sourceDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Model$Source,
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'url', elm$json$Json$Decode$string));
var elm$json$Json$Decode$map4 = _Json_map4;
var author$project$Model$eventDecoder = A5(
	elm$json$Json$Decode$map4,
	author$project$Model$Event,
...
var author$project$Model$rantDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Model$Rant,
	A2(elm$json$Json$Decode$field, 'text', elm$json$Json$Decode$string),
	A2(
...
var author$project$Tape$fromList = F2(
	function (x, lst) {
		if (!lst.b) {
			return author$project$Tape$single(x);
		} else {
			var y = lst.a;
			var ys = lst.b;
...
var author$project$Tape$rewind = function (_n0) {
	rewind:
	while (true) {
		var left = _n0.a;
		var x = _n0.b;
		var right = _n0.c;
		if (!left.b) {
			return A3(author$project$Tape$Tape, left, x, right);
		} else {
			var y = left.a;
			var ys = left.b;
			var $temp$_n0 = A3(
				author$project$Tape$Tape,
				ys,
				y,
				A2(elm$core$List$cons, x, right));
			_n0 = $temp$_n0;
			continue rewind;
		}
	}
...
var elm$http$Http$expectJson = function (decoder) {
	return elm$http$Http$expectStringResponse(
		function (response) {
			var _n0 = A2(elm$json$Json$Decode$decodeString, decoder, response.eO);
			if (_n0.$ === 1) {
		...
		return elm$http$Http$request(
			{
				...
				cX: elm$http$Http$expectJson(decoder),
				bR: _List_Nil,
				c6: 'GET',
...
var author$project$App$getJsonRequest = A2(
	elm$http$Http$send,
	author$project$Update$FetchStories,
	A2(elm$http$Http$get, '/static/data.json', author$project$Model$modelDecoder));
var author$project$Update$Next = {$: 0};
var author$project$Update$NoOp = {$: 2};
var author$project$Update$Prev = {$: 1};
var author$project$App$key = function (keycode) {
	switch (keycode) {
		case 37:
			return author$project$Update$Prev;
		case 39:
			return author$project$Update$Next;
		default:
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {dT: fragment, dV: host, ea: path, ec: port_, eg: protocol, eh: query};
	});
...
var author$project$Model$FromLeft = 0;
...
var author$project$Tape$mapHead = F2(
	function (f, _n0) {
		var left = _n0.a;
		var x = _n0.b;
		var right = _n0.c;
...
var author$project$Tape$popRight = function (_n0) {
	...
	if (!right.b) {
		return _Utils_Tuple2(
			elm$core$Maybe$Nothing,
			A3(author$project$Tape$Tape, left, x, right));
	} else {
		var y = right.a;
		var ys = right.b;
		return _Utils_Tuple2(
...
var author$project$Update$resetStoryState = function (tape) {
	return A2(
		author$project$Tape$mapHead,
		function (st) {
			return _Utils_update(
				st,
				{dk: 0});
...
var author$project$Update$advance = function (m) {
	...
	switch (_n0) {
		...
		case 1:
			var _n1 = author$project$Tape$popRight(m.a3);
			if (!_n1.a.$) {
				var y = _n1.a.a;
				var tape = _n1.b;
				return _Utils_update(
					m,
					{
						a3: author$project$Update$resetStoryState(tape)
					});
			} else {
				var _n2 = _n1.a;
				var tape = _n1.b;
...
var author$project$Tape$popLeft = function (_n0) {
	var left = _n0.a;
	var x = _n0.b;
	var right = _n0.c;
	if (!left.b) {
		...
		switch (msg.$) {
			...
			case 3:
				return A2(
					...
					A2(author$project$Update$toggleStoryState, 0, 1),
					m);
			case 4:
				return A2(
					author$project$Model$mapStory,
					A2(author$project$Update$toggleStoryState, 0, 2),
					m);
			case 5:
				return A2(
					author$project$Model$mapStory,
...
var author$project$Update$update = F2(
	function (msg, m) {
		...
		switch (msg.$) {
			case 0:
				return A2(author$project$Update$clearTransition, 0, _new);
			case 1:
				return A2(author$project$Update$clearTransition, 1, _new);
			default:
				return _Utils_Tuple2(_new, elm$core$Platform$Cmd$none);
		}
	});
var author$project$Tape$read = function (_n0) {
	var left = _n0.a;
	var x = _n0.b;
	var right = _n0.c;
	return x;
};
var author$project$Model$readStory = function (m) {
	return author$project$Tape$read(m.a3);
};
...
var author$project$Ui$styleSheet = function (url) {
	return A3(
		elm$html$Html$node,
		'link',
		_List_fromArray(
...
var author$project$Ui$styleElements = _List_fromArray(
	[
		author$project$Ui$styleSheet('https://fonts.googleapis.com/css?family=Roboto+Slab|Roboto+Mono'),
		author$project$Ui$styleSheet('https://use.fontawesome.com/releases/v5.4.1/css/all.css'),
		author$project$Ui$styleSheet('https://cdnjs.cloudflare.com/ajax/libs/normalize/8.0.0/normalize.css'),
		author$project$Ui$styleSheet('/static/main.css')
	]);
var author$project$Model$Quote = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
...
var author$project$Ui$attrsFromQuote = function (st) {
	var clean = A2(
		elm$core$String$join,
		' ',
		elm$core$String$words(st));
	var n = elm$core$String$length(clean);
	return (n > 200) ? _List_fromArray(
		[
	...
	A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Eles se dizem cristãos, mas na verdade propagam a intolerância. O deputado '),
						A2(
						elm$html$Html$strong,
						_List_Nil,
						_List_fromArray(
...
var author$project$Update$ToggleVideo = {$: 4};
var author$project$View$showVideoOverlay = function (st) {
	var cls = function () {
		var _n0 = st.dk;
		if (_n0 === 2) {
			return 'Video';
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(author$project$Ui$youtubeIframe, '', st.eK),
						A2(
						elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								...
								A2(author$project$Ui$fab, author$project$Update$ToggleVideo, 'fas fa-times'),
								A2(author$project$Ui$fab, author$project$Update$Next, 'fas fa-chevron-right')
							]))
					]))
			]));
};
var author$project$Update$ToggleEvents = {$: 5};
var author$project$View$viewSource = function (_n0) {
	var name = _n0.e8;
	var url = _n0.fo;
	return A2(
		elm$html$Html$cite,
...
var author$project$View$viewEvent = function (_n0) {
	...
	var link = function (elem) {
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$href(source.fo),
					elm$html$Html$Attributes$target('_blank'),
					elm$html$Html$Attributes$alt(source.e8)
				]),
			_List_fromArray(
				[elem]));
	};
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$View$viewSource(source)
			]));
};
var elm$virtual_dom$VirtualDom$lazy = _VirtualDom_lazy;
var elm$html$Html$Lazy$lazy = elm$virtual_dom$VirtualDom$lazy;
var author$project$View$viewEvents = function (st) {
	return A2(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$div,
						_List_Nil,
						A2(elm$core$List$map, author$project$View$viewEvent, events)),
						A2(
						elm$html$Html$div,
						_List_fromArray(
							[
...
var author$project$Update$ToggleRants = {$: 3};
var elm$html$Html$q = _VirtualDom_node('q');
var author$project$View$viewRant = function (rant) {
	var links = function () {
		var _n0 = rant.et;
		if (!_n0.$) {
			var name = _n0.a.e8;
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('#'),
								elm$html$Html$Events$onClick(author$project$Update$ToggleVideo)
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						(st.dk === 1) ? 'fas fa-minus' : 'fas fa-plus'),
						A2(author$project$Ui$fab, author$project$Update$Next, 'fas fa-chevron-right')
					])),
				A2(
				elm$html$Html$div,
				...
				_Utils_ap(
					A2(elm$core$List$map, author$project$View$viewRant, st.ei),
					_List_fromArray(
						[
							A2(
							elm$html$Html$div,
...
var author$project$View$view = function (m) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class(revealClass)
			]),
		_Utils_ap(
			author$project$Ui$styleElements,
			_List_fromArray(
				[content])));
};
...
var author$project$App$main = elm$browser$Browser$element(
	{
		...
		fi: author$project$App$subscriptions,
		fm: author$project$Update$update,
		fp: author$project$View$view
	});
