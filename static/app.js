	...
	return A2(
		...
		function (st) {
			return _Utils_update(
				st,
				{state: $author$project$Model$ShowCover});
		},
		tape);
};
var $author$project$Update$advance = function (m) {
	...
	switch (_v0.$) {
		...
		case 'ShowStory':
			var _v1 = $author$project$Tape$popRight(m.stories);
			if (_v1.a.$ === 'Just') {
				var y = _v1.a.a;
				var tape = _v1.b;
				return _Utils_update(
					m,
					{
						stories: $author$project$Update$resetStoryState(tape)
					});
			} else {
				var _v2 = _v1.a;
				var tape = _v1.b;
				return _Utils_update(
					m,
					{
						state: $author$project$Model$FinishPage(false)
					});
			}
		default:
			var bool = _v0.a;
			return _Utils_update(
				m,
				{
					...
					stories: $author$project$Update$resetStoryState(
						$author$project$Tape$rewind(m.stories))
				});
	}
};
var $author$project$Tape$popLeft = function (_v0) {
	var left = _v0.a;
	var x = _v0.b;
	var right = _v0.c;
	if (!left.b) {
...
var $author$project$Update$back = function (m) {
	...
	switch (_v0.$) {
		...
		case 'ShowStory':
			var _v1 = $author$project$Tape$popLeft(m.stories);
			if (_v1.a.$ === 'Just') {
				var y = _v1.a.a;
				var tape = _v1.b;
				return _Utils_update(
...
var $author$project$Update$toggleStoryState = F3(
	function (a, b, st) {
		return _Utils_eq(st.state, b) ? _Utils_update(
			st,
			{state: a}) : _Utils_update(
			st,
			{state: b});
	});
...
var $author$project$Tape$read = function (_v0) {
	var x = _v0.b;
	return x;
};
var $author$project$Model$readStory = function (m) {
	return $author$project$Tape$read(m.stories);
};
...
var $author$project$Ui$appLayout = F4(
	function (url, linkInit, _v0, child) {
		var quote = _v0.a;
		var from = _v0.b;
		var quoteDiv = A2(
			$elm$html$Html$div,
...
var $author$project$Update$ToggleLinks = {$: 'ToggleLinks'};
...
var $author$project$Update$ToggleVideo = {$: 'ToggleVideo'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$Ui$youtubeIframe, '', st.youtube),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
...
var $author$project$Update$ToggleEvents = {$: 'ToggleEvents'};
var $elm$virtual_dom$VirtualDom$lazy = _VirtualDom_lazy;
var $elm$html$Html$Lazy$lazy = $elm$virtual_dom$VirtualDom$lazy;
var $elm$html$Html$Attributes$alt = $elm$html$Html$Attributes$stringProperty('alt');
var $elm$html$Html$img = _VirtualDom_node('img');
var $author$project$View$viewSource = function (_v0) {
	var name = _v0.name;
	var url = _v0.url;
	return A2(
		$elm$html$Html$cite,
...
var $author$project$View$viewEvent = function (_v0) {
	var title = _v0.title;
	var text = _v0.text;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					A2($elm$core$List$map, $author$project$View$viewRant, st.rants),
					_List_fromArray(
						[
							A2(
							$elm$html$Html$div,
...
var $author$project$View$viewStory = function (st) {
	return A4(
		...
		'.' + st.image,
		true,
		A2($author$project$Model$Quote, st.bible, st.ref),
		_Utils_eq(st.state, $author$project$Model$ShowEvents) ? $author$project$View$viewEvents(st) : (_Utils_eq(st.state, $author$project$Model$ShowVideo) ? $author$project$View$showVideoOverlay(st) : $author$project$View$viewShowMore(st)));
};
var $author$project$View$viewWrapper = F2(
	function (styles, m) {
		var revealClass = function () {
			var _v1 = m.transition;
			switch (_v1.$) {
				case 'FromLeft':
					return 'FromLeft';
				case 'FromRight':
