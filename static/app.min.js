...
{
	if (region.J.y === region.R.y)
	{
		return 'on line ' + region.J.y;
	}
	return 'on lines ' + region.J.y + ' through ' + region.R.y;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aM, request.a$, true);
		} catch (e) {
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aB: false, aD: r.aD, aH: r.aH, V: r.V, aM: r.aM, aX: r.aX, at: r.at, a$: r.a$}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aD: $elm$http$Http$emptyBody, aH: r.aH, V: _List_Nil, aM: 'GET', aX: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, a$: r.a$});
};
var $author$project$Model$IntroPage = {$: 0};
var $author$project$Model$Model = F3(
	function (stories, state, transition) {
		return {K: state, z: stories, aZ: transition};
	});
var $author$project$Model$Reset = 3;
var $author$project$Model$ShowCover = 0;
var $author$project$Model$defaultStory = {N: '<default>', P: 'Bolsonaro, Deputado Federal', T: _List_Nil, E: '', ah: _List_Nil, ai: '<default>', K: 0, au: '<default>', aA: ''};
...
var $author$project$Model$Story = F9(
	function (state, bible, ref, utter, context, youtube, image, events, rants) {
		return {N: bible, P: context, T: events, E: image, ah: rants, ai: ref, K: state, au: utter, aA: youtube};
	});
var $author$project$Model$Event = F4(
	function (title, text, source, image) {
		return {E: image, ap: source, as: text, aY: title};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Model$Source = F2(
	function (name, url) {
		return {aN: name, a$: url};
	});
	...
	switch (_v0.$) {
		case 0:
			return _Utils_update(
				m,
				{
					K: $author$project$Model$ShowStory,
					z: $author$project$Update$resetStoryState(m.z)
				});
		case 1:
			var _v1 = $author$project$Tape$popRight(m.z);
			if (!_v1.a.$) {
				var y = _v1.a.a;
				var tape = _v1.b;
				return _Utils_update(
					m,
					{
						z: $author$project$Update$resetStoryState(tape)
					});
			} else {
				var _v2 = _v1.a;
				var tape = _v1.b;
				return _Utils_update(
					m,
					{
						K: $author$project$Model$FinishPage(false)
					});
			}
		default:
			var bool = _v0.a;
			return _Utils_update(
				m,
				{
					K: $author$project$Model$IntroPage,
					z: $author$project$Update$resetStoryState(
						$author$project$Tape$rewind(m.z))
				});
	}
};
...
var $author$project$Update$back = function (m) {
	...
	switch (_v0.$) {
		...
		case 1:
			var _v1 = $author$project$Tape$popLeft(m.z);
			if (!_v1.a.$) {
				var y = _v1.a.a;
				var tape = _v1.b;
				return _Utils_update(
		...
		default:
			return _Utils_update(
				m,
				{
					K: $author$project$Model$ShowStory,
					z: $author$project$Tape$rewind(
						$author$project$Update$resetStoryState(m.z))
				});
	}
};
...
var $author$project$Model$mapStory = F2(
	function (f, m) {
		return _Utils_update(
			m,
			{
				z: A2($author$project$Tape$mapHead, f, m.z)
			});
	});
...
var $author$project$Update$toggleState = F3(
	function (a, b, m) {
		var state = _Utils_eq(m.K, a) ? b : (_Utils_eq(m.K, b) ? a : m.K);
		return _Utils_update(
			m,
			{K: state});
	});
var $author$project$Update$toggleStoryState = F3(
	function (a, b, st) {
		return _Utils_eq(st.K, b) ? _Utils_update(
			st,
			{K: a}) : _Utils_update(
			st,
			{K: b});
...
var $author$project$Main$mainWrapper = function (view) {
	var getJsonRequest = $elm$http$Http$get(
		{
			aH: A2($elm$http$Http$expectJson, $author$project$Update$FetchStories, $author$project$Model$modelDecoder),
			a$: './static/data.json'
		});
	return $elm$browser$Browser$element(
		{
			...
			a_: $author$project$Update$update,
			a0: view
		});
};
...
var $author$project$Model$readStory = function (m) {
	return $author$project$Tape$read(m.z);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$Ui$youtubeIframe, '', st.aA),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
...
var $author$project$View$viewEvent = function (_v0) {
	...
	var link = function (elem) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href(source.a$),
					$elm$html$Html$Attributes$target('_blank'),
					$elm$html$Html$Attributes$alt(source.aN)
				]),
			_List_fromArray(
				[elem]));
	};
...
var $author$project$Model$FromLeft = 1;
var $author$project$Model$FromRight = 2;
...
var $author$project$Model$FadeOut = 0;
...
var $author$project$View$viewShowMore = function (st) {
	...
	var fabMiddle = (st.K === 1) ? A2($author$project$Ui$fab, $author$project$Update$ToggleRants, 'fas fa-minus') : A2($author$project$Ui$fabText, $author$project$Update$ToggleRants, 'saiba mais');
	var backCover = A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
	...
	var navChildren = $elm$core$List$isEmpty(st.ah) ? _List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($author$project$View$fade, $author$project$Update$Prev, 2),
						'fas fa-chevron-left'),
						fabMiddle,
						A2(
						$author$project$Ui$fab,
						A2($author$project$View$fade, $author$project$Update$Next, 1),
				...
				_Utils_ap(
					A2($elm$core$List$map, $author$project$View$viewRant, st.ah),
					_List_fromArray(
						[
							A2(
							$elm$html$Html$div,
...
var $author$project$View$viewStory = function (st) {
	return A4(
		...
		'.' + st.E,
		true,
		A2($author$project$Model$Quote, st.N, st.ai),
		(st.K === 3) ? $author$project$View$viewEvents(st) : ((st.K === 2) ? $author$project$View$showVideoOverlay(st) : $author$project$View$viewShowMore(st)));
};
